/*
  gcode.c - Implementation parser g-code rs274/ngc
  
  CHỨC NĂNG:
  - Parser g-code theo chuẩn NIST RS274-NGC v3
  - Phân tích và validate lệnh G-code và M-code
  - Quản lý modal groups và coordinate systems
  - Chuyển đổi g-code thành motion blocks cho planner
...
// Số dòng tối đa - chuẩn g-code là 99999, nhưng một số GUI cần nhiều hơn
// Tăng lên dựa trên giá trị an toàn khi convert float sang integer
#define MAX_LINE_NUMBER 9999999 

// Loại lệnh trục
#define AXIS_COMMAND_NONE 0                    // Không có lệnh trục
#define AXIS_COMMAND_NON_MODAL 1               // Lệnh non-modal
#define AXIS_COMMAND_MOTION_MODE 2             // Lệnh motion mode
#define AXIS_COMMAND_TOOL_LENGTH_OFFSET 3      // Tool length offset

// Struct parser state và block
parser_state_t gc_state;
parser_block_t gc_block;

#define FAIL(status) return(status);

// Khởi tạo parser g-code
void gc_init() 
{
  memset(&gc_state, 0, sizeof(parser_state_t));
  
  // Tải hệ tọa độ mặc định G54
