...
settings_t settings; // Global settings struct

// Lưu startup lines vào EEPROM
...
// Lưu build info vào EEPROM
void settings_store_build_info(char *line)
{
  memcpy_to_eeprom_with_checksum(EEPROM_ADDR_BUILD_INFO,(char*)line, LINE_BUFFER_SIZE);
}

// Lưu coordinate data vào EEPROM
...
// Lưu global settings struct và version number vào EEPROM
void write_global_settings() 
{
  eeprom_put_char(0, SETTINGS_VERSION); // Version ở byte đầu tiên
  memcpy_to_eeprom_with_checksum(EEPROM_ADDR_GLOBAL, (char*)&settings, sizeof(settings_t));
}

// Khôi phục global settings về mặc định
