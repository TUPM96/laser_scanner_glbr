/*
  gcode.h - Header file parser g-code rs274/ngc
  
  CHỨC NĂNG:
  - Parser g-code theo chuẩn NIST RS274-NGC v3
  - Phân tích và thực thi lệnh G-code và M-code
  - Quản lý modal groups và coordinate systems
  - Chuyển đổi g-code thành chuyển động máy
...
// Định nghĩa modal group - các nhóm lệnh g-code loại trừ lẫn nhau
// Modal group là nhóm lệnh không thể tồn tại trên cùng một dòng
// Định nghĩa theo chuẩn NIST RS274-NGC v3
// LƯU Ý: Giá trị modal group phải tuần tự và bắt đầu từ 0
