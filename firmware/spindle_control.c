/*
  spindle_control.c - Implementation điều khiển spindle (trục chính)
...
void spindle_init()
{
    // Cấu hình variable spindle PWM và enable pin nếu cần
    // Trên Uno, PWM và enable được kết hợp trừ khi cấu hình khác
